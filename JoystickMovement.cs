...
public class JoystickMovement : MonoBehaviour {
	...
	//The camera rig attached to the OVALplayer (for finding movement direction)
	...
	void Start()
	{
		cameraRig = transform.FindChild ("LeapOVRCameraRig");
		centerEyeAnchor = cameraRig.FindChild ("TrackingSpace");

		if (cameraRig == null) 
		{
			Debug.LogError("JoystickMovement.cs is attached to an object without an OVRCameraRig child.");
		}
		if (centerEyeAnchor == null) 
		{
			Debug.LogError ("JoystickMovement.cs is attached to an object without a Center Eye Anchor. Check the OVRCameraRig object to ensure it has a Center Eye Anchor attached.");
		}
	}
